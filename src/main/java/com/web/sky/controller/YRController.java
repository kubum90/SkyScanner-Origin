...
public class YRController {
   ...
   @Autowired Member m;
   @Autowired Flight f;
   @Autowired Departure d;
   @Autowired Arrival a;
   @Autowired Reservation r;
   @Autowired GMap gm;
   
   @RequestMapping (value="/post/reserve/")
   public @ResponseBody Map<?,?> insertReserve(){
      logger.info("insert Controller {}", "진입");
      ...
      new IPostService() {
         ...
         public void execute(Object o) {
            tx.reservation(reserve, arrive, depart);
         }
      }.execute(null);
